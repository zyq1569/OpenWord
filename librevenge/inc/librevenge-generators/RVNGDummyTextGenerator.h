...
#ifndef RVNGDUMMYTEXTGENERATOR_H
#define RVNGDUMMYTEXTGENERATOR_H
...
class REVENGE_GENERATORS_API RVNGDummyTextGenerator : public RVNGTextInterface
{
	// disable copying
...
#endif /* RVNGDUMMYTEXTGENERATOR_H */
