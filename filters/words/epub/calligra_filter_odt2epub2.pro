...
TEMPLATE = lib
TARGET = calligra_filter_odt2epub2
DESTDIR = ../../../../calligra/bin/Debug
QT += core xml network gui svg widgets printsupport concurrent dbus
CONFIG += debug
DEFINES += _WINDOWS DEBUG_EPUB=1 WIN32_LEAN_AND_MEAN _WIN32_WINNT=0x0600 WINVER=0x0600 _WIN32_IE=0x0600 _UNICODE _USE_MATH_DEFINES _CRT_SECURE_NO_DEPRECATE _CRT_SECURE_NO_WARNINGS _CRT_NONSTDC_NO_DEPRECATE _SCL_SECURE_NO_WARNINGS QT_DISABLE_DEPRECATED_BEFORE=0 QT_USE_QSTRINGBUILDER QT_STRICT_ITERATORS QT_NO_SIGNALS_SLOTS_KEYWORDS QT_NO_URL_CAST_FROM_STRING QT_NO_CAST_TO_ASCII NOMINMAX BOOST_ALL_NO_LIB TRANSLATION_DOMAIN=\"calligrafilters\" QT_XML_LIB QT_WIDGETS_LIB KCOREADDONS_LIB QT_NETWORK_LIB QT_CONCURRENT_LIB QT_DBUS_LIB QT_PRINTSUPPORT_LIB QT_SVG_LIB CMAKE_INTDIR=\"Debug\" calligra_filter_odt2epub2_EXPORTS
INCLUDEPATH += ../../../../../calligra/filters/words/epub \
    ../../../../../../src/calligra-v3.2.1/filters/words/epub \
    ../../../../../calligra/filters/words/epub/calligra_filter_odt2epub2_autogen/include_Debug \
...
include(calligra_filter_odt2epub2.pri)
